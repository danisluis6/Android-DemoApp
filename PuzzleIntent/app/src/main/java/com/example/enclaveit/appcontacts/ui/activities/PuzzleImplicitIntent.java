...
import com.example.enclaveit.appcontacts.api.SmsManagerAPI;

public class PuzzleImplicitIntent extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configuras();
        setContentView(R.layout.ui_maincall);
        initComponents();
    ...
    private void addOnListenerCall() {
        ...
        btsms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 ...
                 */
                AlertDialog.Builder builder = new AlertDialog.Builder(PuzzleImplicitIntent.this);
                builder.setTitle("Messenger Chat");

                final EditText message = new EditText(PuzzleImplicitIntent.this);
...
//                            Toast.makeText(PuzzleImplicitIntent.this,"SMS send to successfully!",Toast.LENGTH_SHORT).show();
//                        }else{
//                            Toast.makeText(PuzzleImplicitIntent.this,"SMS send to fail. Try again!",Toast.LENGTH_SHORT).show();
//                        }
